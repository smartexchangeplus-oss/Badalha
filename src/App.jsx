...
const COUNTRY_CITIES = {
  "السعودية": [
    "الرياض", "الخرج", "الدوادمي", "المجمعة", "الزلفي", "وادي الدواسر", "الأفلاج", "القويعية", "شقراء",
    "جدة", "مكة المكرمة", "الطائف", "رابغ", "القنفذة", "الليث", "الجموم",
    "المدينة المنورة", "ينبع", "العلا", "بدر", "خيبر", "مهد الذهب",
    "الدمام", "الخبر", "الظهران", "الأحساء", "الجبيل", "القطيف", "حفر الباطن", "الخفجي", "رأس تنورة", "بقيق",
    "أبها", "خميس مشيط", "بيشة", "النماص", "محايل عسير", "رجال ألمع", "تثليث",
    "تبوك", "الوجه", "ضباء", "تيماء", "أملج", "حقل",
    "حائل", "بقعاء", "الغزالة",
    "عرعر", "رفحاء", "طريف",
    "جازان", "صبيا", "أبو عريش", "صامطة", "فرسان",
    "نجران", "شرورة", "يدمة",
